...
assert.strictEqual(pkg.version, '2.0.61');
...
console.log('PASS roadmap 2.0.61 preserves the sanitized Recovery Dashboard and restores the real-GUI readiness signal.');
