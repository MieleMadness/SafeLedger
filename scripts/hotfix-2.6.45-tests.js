...
assert.strictEqual(pkg.version, '2.6.45', 'This workflow correction candidate must report SafeLedger 2.6.45.');
...
console.log('PASS SafeLedger 2.6.45 corrects the 2.6.44 test-file preparation error and keeps the preload-wrapper historical fixes active.');
