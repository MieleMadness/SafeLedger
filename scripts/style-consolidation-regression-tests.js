...
assert.deepStrictEqual(importantOwnership.removable, [],
  'Canonical CSS cascade must not contain !important declarations that are always shadowed by later owners.');
printImportantOwnershipReport(importantOwnership);

console.log('PASS canonical stylesheet consolidation uses one ordered app.css cascade, single-owner exact selectors, zero provably shadowed !important declarations, and no retired versioned CSS fixtures.');
