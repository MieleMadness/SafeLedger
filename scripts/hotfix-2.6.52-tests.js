...
assert(parts[0] === 2 && parts[1] === 6 && parts[2] >= 52,
  'Phase 4 UI Consolidation must remain active on SafeLedger 2.6.52 and later 2.6.x candidates.');
...
assert(gate2651.includes('parts[2] >= 51'), 'Phase 3 Data Ownership must remain active on the Phase 4 candidate and later patches.');
...
console.log(`PASS SafeLedger ${pkg.version} keeps Phase 4 UI Consolidation and the Phase 3 persistence boundary active.`);
