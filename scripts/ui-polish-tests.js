...
console.log(`PASS UI polish ${pkg.version} keeps Home/History/Settings/Search in the top utility bar, Emergency Lock fixed bottom-right, equal 2/2/2 navigation columns with a 5fr Detail column plus explicit 56px compact rails, edit cancellation, responsive custom fields, and readable dark-mode contrast.`);
