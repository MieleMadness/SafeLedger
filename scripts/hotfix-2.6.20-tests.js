...
assert(foundation.includes('--sl-compact-nav-column: 98px;'),
  'Collapsible navigation must retain its current balanced compact-rail width.');
...
console.log(`PASS SafeLedger ${pkg.version} keeps the 2.6.20 general sizing gate while validating the current equal expanded columns and balanced compact rails.`);
