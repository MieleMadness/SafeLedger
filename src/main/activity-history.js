...
const EVENT_DEFINITIONS = Object.freeze({
  ...
  'session-locked-manual': Object.freeze({ label: 'SafeLedger locked manually', category: 'security', icon: 'fa-lock' }),
  'session-locked-screen': Object.freeze({ label: 'SafeLedger locked with the operating system', category: 'security', icon: 'fa-lock' }),
  'session-locked-suspend': Object.freeze({ label: 'SafeLedger locked for system suspend', category: 'security', icon: 'fa-lock' }),
  'session-locked-resume': Object.freeze({ label: 'SafeLedger locked on system resume', category: 'security', icon: 'fa-lock' }),
  'session-locked-storage-unavailable': Object.freeze({ label: 'SafeLedger locked because storage became unavailable', category: 'security', icon: 'fa-lock' }),
  'session-locked-idle-state': Object.freeze({ label: 'SafeLedger locked by device security state', category: 'security', icon: 'fa-lock' }),
  'session-locked-data-change': Object.freeze({ label: 'SafeLedger locked after a data change', category: 'security', icon: 'fa-lock' }),
  'complete-data-backup-exported': Object.freeze({ label: 'Complete backup created', category: 'data', icon: 'fa-archive' }),
  'complete-data-backup-verified': Object.freeze({ label: 'Complete backup verified', category: 'data', icon: 'fa-check-circle' }),
  ...
  'wallet-created': Object.freeze({ label: 'Wallet created', category: 'data', icon: 'fa-plus' }),
  ...
  'asset-created': Object.freeze({ label: 'Asset created', category: 'data', icon: 'fa-plus' }),
  ...
  'self-destruct-protection-changed': Object.freeze({ label: 'Self-Destruct Protection changed', category: 'security', icon: 'fa-warning' }),
