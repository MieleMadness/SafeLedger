...
const renderRecordDetail=(params)=>{
  ...
  addLine('Symbol',params.record.symbol);addLine('Tags',params.record.tags);addLine('Last known balance',params.record.manualBalance);addLine('Balance updated',params.record.balanceUpdated,formatEasternDate);
  ...
  detailActions.set([
    {icon:'fa-print',title:'Print coin sheet',className:'detail-action-print',onClick:()=>securityUi.printRecoverySheet(`${params.record.name||'Coin'} Recovery Sheet`,[{label:'Coin',value:params.record.name},{label:'Symbol',value:params.record.symbol},{label:'Tags',value:params.record.tags},{label:'Public address',value:params.record.publicAddress},{label:'Private key',value:params.record.privateAddress},{label:'Last known balance',value:params.record.manualBalance},{label:'Balance updated',value:params.record.balanceUpdated},{label:'Notes',value:getUserCoinNotes(params.vaultData,params.record)}],!!params.record.privateAddress)},
